...
_REGIME_STRATEGIES: Dict[str, List[str]] = {
    ...
    "trending_down": ["tianjie_value_investment", "shrink_pullback", "bottom_volume"],
    "sideways": ["tianjie_value_investment", "box_oscillation", "shrink_pullback"],
    "volatile": ["chan_theory", "wave_theory"],
    "sector_hot": ["dragon_head", "emotion_cycle"],
}

# Fallback when regime can't be determined
_DEFAULT_STRATEGIES = ["tianjie_value_investment", "bull_trend", "shrink_pullback"]
...
>>>>>>> 84c6e85 (wip: save local changes)
